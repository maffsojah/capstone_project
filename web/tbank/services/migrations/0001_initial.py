# -*- coding: utf-8 -*-
# Generated by Django 1.10.6 on 2017-03-29 05:15
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Customer_Loyalty', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='services.Customer')),
            ],
            options={
                'ordering': ['Name'],
                'db_table': 'customers',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('service_name', models.IntegerField(choices=[(0, 'Silver'), (1, 'Gold'), (2, 'Platinum')])),
        ...
        migrations.AddField(
            model_name='customer',
            name='Service_Level',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='services.ServiceLevel'),
        ),
    ]
