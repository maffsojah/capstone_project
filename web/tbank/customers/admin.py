...
#         elif feat_list() > 15:
#             customer.Service_Level = Service.object.get(service_name = "Platinum Package")
...
def allocate_service(ModelAdmin, request, queryset):
    ...
    for customer in queryset:
        ...
        data = [(Customer.objects.values_list("Gender", "Account_Type", "Age","Education", "Employment", "Employer_Stability", "Residential_Status", "Salary", "Customer_Loyalty", "Balance").get(pk=customer.Customer_ID))]
