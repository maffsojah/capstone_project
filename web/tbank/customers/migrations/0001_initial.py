    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('salary', models.IntegerField(help_text='&#36;')),
        ...
        migrations.CreateModel(
            name='Service',
            fields=[
                ('service_no', models.CharField(max_length=4, primary_key=True, serialize=False)),
        ...
        migrations.AddField(
            model_name='customer',
            name='service',
            field=models.ForeignKey(db_column='service_name', on_delete=django.db.models.deletion.CASCADE, to='customers.Service'),
        ),
    ]
